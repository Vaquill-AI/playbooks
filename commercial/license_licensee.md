# License Agreement - Licensee side

> You're licensing software, data, or IP from a vendor. Locks down scope of use, audit limitations, IP indemnification, and fair use after termination.

**Side:** Licensee · **Jurisdiction:** US

**Best fit for:**

- On-prem software license
- Licensing third-party data sets
- Receiving a technology license from a partner

**Tags:** `license`, `licensee`, `software`, `ip`
...
Mutual cap at the greater of 12 months fees or the license fee paid, with carveouts (UNCAPPED) for: IP indemnification, breach of confidentiality, and willful misconduct.
...
1. Mutual cap at the greater of 12 months fees or the license fee paid, with IP indemnification, confidentiality, and willful misconduct uncapped.
2. Mutual cap at 12 months fees with a defined super-cap of 2x to 3x fees for confidentiality and a preserved uncapped IP indemnity.
3. Mutual cap at 12 months fees with the IP-indemnity carveout preserved above the cap and other carveouts inside it.

**Walk-away floor**

Walk away if the IP-indemnity and confidentiality carveouts are folded inside a general cap set below 12 months fees.

**Escalation triggers**

- Cap below 12 months fees or the license fee paid
- IP indemnity or confidentiality folded inside the general cap
- Consequential damages not excluded

**Rationale**

The liability cap sets the licensee's maximum recovery when the licensed materials fail, so an undersized cap or a missing IP-indemnity carveout can leave real losses uncompensated.
...
Licensor indemnifies licensee against IP infringement claims relating to the licensed materials. Remedies: (i) procure right to continue use, (ii) modify to be non-infringing without material loss of function, or (iii) refund unamortized fees. UNCAPPED for IP.
...
1. Uncapped IP-infringement indemnity with procure, modify, or refund-unamortized-fees as the licensee's remedies and the licensor bearing defense costs.
2. IP-infringement indemnity super-capped above the general liability cap, with procure or modify as the primary remedy and a refund fallback.
3. IP-infringement indemnity preserved above the general cap for unmodified use, with the refund of unamortized fees as the backstop remedy.

**Walk-away floor**

Walk away if the IP indemnity is capped at fees or the licensee has no remedy when the licensor cannot procure or modify the infringing materials.

**Escalation triggers**

- IP indemnity capped at fees
- No licensee remedy if licensor cannot procure / modify
- Licensee bears defense costs for indemnified claims

**Rationale**

A third-party IP claim against the licensed materials can halt the licensee's use entirely, so the licensor must stand behind the grant with an uncapped indemnity and a real remedy.
...
Licensee may terminate for licensor's material breach with 30-day cure. Licensor may terminate for non-payment or material licensee breach with 30-day cure. On termination: licensee winds down use over 90 days; perpetual licenses for fully-paid versions survive; licensee retains read-only access to historical data.
...
- Immediate cessation of use on termination (no wind-down)
- Loss of historical data / outputs on termination
- Licensor termination for convenience

**Rationale**

A wind-down period and survival of fully-paid perpetual licenses protect the licensee from an abrupt loss of use and of its historical data on termination.
...
Licensee receives a non-exclusive, sublicensable to affiliates and contractors, perpetual (for fully-paid) or term-bound license for the licensed scope. Licensor retains ownership. Improvements / derivatives created by licensee remain licensee's, subject to scope of license to underlying tech.
...
1. Non-exclusive license sublicensable to affiliates and contractors, perpetual for fully-paid versions, with licensee retaining ownership of its own improvements.
2. Non-exclusive license extending to affiliates and named contractors, term-bound but co-terminous with the payment commitment, with a wind-down of use on expiry.
3. Non-exclusive license limited to the licensee's own internal use for the paid term, with licensee improvements owned by the licensee subject to the underlying-tech license.

**Walk-away floor**

Walk away if the license term is shorter than the payment commitment or the licensor claims ownership of the licensee's own improvements.

**Escalation triggers**

- License term shorter than payment commitment
- No sublicense to affiliates / contractors
- Licensor claims rights in licensee improvements
- Use restrictions tied to revenue thresholds without consideration

**Rationale**

The license scope defines exactly what the licensee is paying for, so a term or grant narrower than the business use leaves the licensee without the rights it bargained for.
...
Licensor audit right limited to once per year, with 30 days' notice, during business hours, by licensor's auditor under NDA, with confidentiality protections. Licensee pays only material-non-compliance findings.
...
- Audits more frequent than once per year
- Licensor's auditor selected unilaterally with no NDA
- Licensee bears all audit costs regardless of findings
- Audit data extending beyond license-compliance scope

**Rationale**

Bounding audit frequency, notice, and cost exposure keeps a compliance check from becoming an open-ended burden or a fishing expedition into the licensee's systems.
