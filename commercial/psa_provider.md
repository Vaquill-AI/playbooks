# Professional Services (PSA + SOW) - Provider side

> Provider-side master services agreement. Assigns deliverables on payment, keeps a deemed-acceptance mechanic, retains tools and methodologies, and caps liability per SOW.

**Side:** Vendor · **Jurisdiction:** US

**Best fit for:**

- Provider's standard master services agreement + SOW
- Services firm ordering work via SOWs

**Tags:** `psa`, `professional-services`, `sow`, `provider`
...
Mutual cap at 12 months of the affected SOW's fees (not aggregate across SOWs). Offer a data/security super-cap instead of uncapped; reserve uncapped exposure for fraud, willful misconduct, and the IP indemnity. Exclude consequential / indirect damages.
...
1. Mutual cap at 12 months of the affected SOW's fees, with consequential and indirect damages excluded and uncapped exposure only for fraud, willful misconduct, and the IP indemnity.
2. Mutual cap at 12 months of the affected SOW's fees with a defined data-security super-cap of 2x to 3x fees instead of uncapped data-breach liability.
3. Mutual cap at 18 months of the affected SOW's fees where the client insists on a higher floor, still excluding consequential damages.

**Walk-away floor**

Walk away if the cap is aggregated across all SOWs rather than per affected SOW, or consequential damages are left in.

**Escalation triggers**

- Uncapped liability outside fraud / willful misconduct / IP indemnity
- Cap aggregated across all SOWs rather than per affected SOW
- Consequential / indirect damages not excluded

**Rationale**

A per-SOW cap with a data-security super-cap instead of uncapped exposure, and consequential damages excluded, bounds the provider's downside on any single engagement.
...
Client owns SOW deliverables assigned UPON FULL PAYMENT of the associated fees; until then the provider retains title. Provider retains all pre-existing tools, frameworks, methodologies, and improvements, and a license-back to residual know-how.
...
1. Assignment of SOW deliverables upon full payment, with the provider retaining all pre-existing tools, frameworks, and methodologies and a license-back to residual know-how.
2. Assignment on full payment with a perpetual, royalty-free license back to the provider for any general methodologies embedded in the deliverables.
3. Perpetual, exclusive license to the client on full payment where the client refuses assignment of provider-owned components.

**Walk-away floor**

Walk away if the client claims ownership of the provider's pre-existing tools or methodologies, or takes deliverable title before full payment.

**Escalation triggers**

- Deliverable ownership transfers before full payment
- Client claims ownership of provider pre-existing tools or methodologies
- No license-back for residual know-how

**Rationale**

Assigning deliverables only on full payment while retaining the provider's tools, methodologies, and residual know-how protects both the provider's payment leverage and its reusable IP.
...
Workmanlike-manner warranty conforming to the SOW; NO guaranteed result. Deliverables are DEEMED ACCEPTED if not rejected in writing against objective SOW criteria within the review period, with a resubmission right to cure; re-perform is the sole warranty remedy. Reasonable personnel substitution on notice.
...
- Open-ended or subjective client acceptance right with no deemed-acceptance
- Refund (rather than re-perform) as the warranty remedy
- Guaranteed-result or fitness-for-purpose warranty

**Rationale**

A deemed-acceptance mechanic with re-perform as the sole remedy and no guaranteed-result warranty caps the provider's exposure to open-ended acceptance disputes and refund demands.
...
Net 30. Late fee 1.5% per month. Right to suspend work for non-payment of undisputed amounts on notice. Milestone / kill-fee protection on early termination for work performed and reserved capacity. Pre-approved expenses at cost.
...
- No payment for work performed on early termination

**Rationale**

Net 30 with a suspension right for non-payment and kill-fee protection on early termination secures the provider's cash flow and pay for work already performed.
...
The master agreement's legal terms (IP, liability, warranty, indemnity) control and cannot be varied by an SOW unless the SOW expressly references and amends the specific master section. SOWs cover scope, fees, and schedule only.
...
- SOWs silently override the master's liability / IP / warranty terms
- Client purchase-order terms take precedence over the master
- No requirement that SOW amendments expressly reference the master section

**Rationale**

Anchoring the master's legal terms so an SOW cannot vary them unless it expressly amends the section keeps the provider's IP, liability, and warranty positions intact across engagements.
