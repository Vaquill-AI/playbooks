# Service Level Agreement (SLA) - Customer side

> You're the customer negotiating uptime and support commitments. Pushes a meaningful uptime target, narrow exclusions, real service credits, and a right to walk (with a refund) after chronic failure.

**Side:** Customer · **Jurisdiction:** US

**Best fit for:**

- Negotiating a vendor's SLA / uptime commitment
- Adding an SLA attachment to a SaaS agreement

**Tags:** `sla`, `uptime`, `service-credits`, `support`, `customer`
...
Service credits are a remedy for availability misses but NOT the SOLE remedy where the same failure also breaches security, confidentiality, or data-protection obligations; and chronic failure triggers the termination-and-refund right above.
...
1. Credits are the sole remedy ONLY for pure availability misses; security / confidentiality / data-protection breaches keep their own remedies
2. Credits sole for availability, with a carve-out for any downtime that causes a data or security incident
3. Credits sole for availability, but never the sole remedy where the same event triggers the termination-and-refund right

**Walk-away floor**

Service credits stated as the sole and exclusive remedy for ALL SLA failures, sweeping in security, confidentiality, and data-protection incidents.

**Escalation triggers**

- Service credits stated as the sole and exclusive remedy for all SLA failures, including security / data incidents
- Downtime that causes a data incident limited to a credit

**Rationale**

'Credits are your sole remedy' is the clause that turns a data-breach or confidentiality failure into a small refund; the carve-out keeps real remedies alive for real harm.
...
In addition to credits, the customer may terminate without penalty and receive a pro-rata refund of prepaid fees after chronic failure (e.g. three consecutive months, or any three months in a rolling twelve, below the committed level).
...
- No termination right for chronic / persistent SLA failure
- No refund of prepaid fees on chronic-failure termination
- Credits are the only consequence of even repeated misses

**Rationale**

Without a chronic-failure exit, a vendor can miss the target every month and owe only small credits, locking the customer into a service that does not work.
...
Uptime commitment of at least 99.9% monthly, measured over a rolling calendar month, with a NARROW, defined exclusions list (only pre-notified maintenance windows and genuine force majeure -- no open-ended 'any factor outside vendor control'). Tiered service credits that scale meaningfully with downtime. Vendor monitoring is authoritative only absent the customer's showing of material error. Severity-tiered support with a P1 response target of <= 1 hour and defined restoration targets.

**Acceptable range**

99.5%-99.99% depending on tier and price. Credits requested within 30-60 days. Maintenance windows excluded only if pre-notified and within a capped monthly duration.

**Fallback ladder** (best acceptable first)

1. 99.9% monthly uptime, narrow exclusions, tiered credits, P1 response <= 1 hour
2. 99.7% monthly uptime with a capped monthly maintenance window and tiered credits
3. 99.5% monthly uptime (floor) with defined exclusions and a real credit schedule

**Walk-away floor**

No measured uptime commitment at all, OR exclusions so broad ('any factor outside the vendor's control') that the commitment is illusory.

**Escalation triggers**

- Uptime commitment below 99.9% (or no measured commitment at all)
...
- Maintenance windows excluded without advance notice or duration cap
- No support response / restoration targets
- Vendor monitoring conclusive with no customer challenge right

**Rationale**

The uptime commitment is the whole point of the SLA. A soft or unmeasured target with open-ended exclusions leaves the customer carrying the downtime risk on a service it depends on.
