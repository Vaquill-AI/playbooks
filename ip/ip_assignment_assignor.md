# IP Assignment - Assignor side

> You're the party assigning IP (a contractor, founder, or seller). Assigns only the specifically identified work, retains background IP with a license-back, warrants ownership only, and conditions the assignment on payment.

**Side:** Other · **Jurisdiction:** US

**Best fit for:**

- Assigning work product to a client on a SOW
- Selling or contributing IP as a founder or contractor

**Tags:** `ip`, `assignment`, `assignor`, `contractor`, `founder`
...
Indemnity limited to breach of the ownership / authority warranty, capped at the consideration paid. No uncapped or open-ended indemnity; no indemnity for the assignee's use, modification, or combination of the work.
...
1. Indemnity limited to breach of the ownership and authority warranty, capped at the consideration paid, with no indemnity for the assignee's use or modification.
2. Indemnity for breach of the ownership warranty plus direct infringement of the delivered work, capped at the consideration paid.
3. Indemnity capped at a multiple of the consideration for breach of the ownership warranty, provided the assignee's use, modification, and combination stay excluded.

**Walk-away floor**

An uncapped indemnity, or indemnity for the assignee's use, modification, or combination of the work.

**Escalation triggers**

- Uncapped indemnity
- Indemnity for the assignee's use / modification / combination
- Indemnity beyond breach of the ownership warranty

**Rationale**

Capping indemnity at the consideration and tying it to the ownership warranty stops the assignor from carrying open-ended infringement risk.
...
Assignment does not take effect until payment; if the assignee fails to pay, rights do not transfer. Further-assurances cooperation is at the assignee's expense and capped in time.
...
- Assignment effective regardless of payment
- Open-ended further-assurances obligation at the assignor's expense

**Rationale**

Conditioning the transfer on payment keeps the assignor's leverage until it is actually paid for the IP.
...
Assign ONLY the specifically identified work product. Retain all background / pre-existing IP, tools, and general know-how via a Background IP Schedule, granting the assignee a license limited to use within the delivered work. Assignor keeps a license-back for internal and portfolio use. Assignment is conditioned on full payment. No trailing-IP or residuals sweep of future work.
...
1. Assignment of only the identified work product, background IP retained with a use-limited license to the assignee and a broad license-back for the assignor.
2. Assignment of the identified work product with a perpetual license-back for internal and portfolio use, and no trailing or residuals sweep.
3. Assignment of the identified work product with a license-back for internal use only, provided background IP and future work stay expressly excluded.

**Walk-away floor**

A sweep of background or pre-existing IP, a trailing-IP or residuals clause capturing future work, or an assignment effective before payment.

**Escalation triggers**

- Assignment sweeps in background / pre-existing IP
- No license-back for internal / portfolio use
- Trailing-IP or residuals clause capturing future work
- Assignment effective before payment

**Rationale**

Narrowing the transfer to the identified deliverable is what protects the assignor's background IP, tools, and future work from being swept away.
...
Warrant ownership and authority to assign only. Disclaim any warranty of non-infringement of unknown third-party rights; knowledge-qualify third-party-dependent reps. Survival capped at 12 months. No open-source warranty beyond disclosed components.
...
1. Warrant ownership and authority to assign only, with all third-party reps knowledge-qualified and survival capped at 12 months.
2. Warrant ownership and authority plus a knowledge-qualified non-infringement rep, with survival capped at 18 months.
3. Warrant ownership and authority with a knowledge-qualified non-infringement rep and a 24-month survival, provided the disclosed open-source list governs.

**Walk-away floor**

An unqualified non-infringement warranty covering unknown third-party rights, or a survival period over 24 months.

**Escalation triggers**

- Unqualified non-infringement warranty covering unknown third-party rights
- Survival over 12-24 months
- Warranty of no third-party claims without a knowledge qualifier

**Rationale**

Limiting warranties to ownership and authority caps the assignor's exposure so it never underwrites unknown third-party rights.
