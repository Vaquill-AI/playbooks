...
> You're the SaaS / service vendor processing customer data. Anchors realistic breach SLAs, sub-processor notice patterns, and limits liability outside vendor negligence.

**Side:** Vendor · **Jurisdiction:** US

**Best fit for:**

- SaaS vendor's standard DPA template
- Service providers handling customer personal data

**Tags:** `dpa`, `processor`, `privacy`, `saas-vendor`
...
Mutual cap at 12 months fees with carveouts limited to: vendor's willful misconduct, vendor's gross negligence in data security, vendor's IP indemnity. Regulatory fines capped at the same level absent willful misconduct.
...
1. Mutual cap at 12 months of fees with breach carve-outs limited to willful misconduct and gross negligence, and regulatory fines capped at the same level absent willful misconduct.
2. A separate data-breach super-cap at a defined multiple of annual fees, above the general cap, with fines inside it.
3. The data-breach cap raised to a higher multiple of annual fees while remaining a defined ceiling, not uncapped.

**Walk-away floor**

Uncapped processor liability, carve-outs for ordinary negligence, or no ceiling at all on regulatory fines.

**Escalation triggers**

- Uncapped liability for processor
- Carveouts for ordinary negligence
- No cap on regulatory fines

**Rationale**

An uncapped or ordinary-negligence carve-out on the processor side turns a single incident into unbounded exposure across our whole customer base, so a bounded cap is deal-critical.
...
Vendor indemnifies for regulatory fines and third-party claims arising from vendor's MATERIAL breach of the DPA, subject to the limitation-of-liability cap (with carveouts above).
...
1. Indemnity for third-party claims and regulatory fines from the vendor's material DPA breach, subject to the liability cap and its carve-outs.
2. Indemnity for third-party claims from the vendor's material breach, with regulatory fines shared inside the cap.
3. Indemnity limited to third-party claims from a proven willful or grossly negligent breach, within the cap.

**Walk-away floor**

Indemnity untied from the liability cap, or triggered by any breach rather than a material breach caused by the vendor.
...
Tying our indemnity to a MATERIAL breach and to the liability cap keeps the obligation bounded and proportionate to the fault we actually caused.
...
Vendor acts as a 'service provider' (CCPA/CPRA) / 'processor' under applicable US state privacy laws (VCDPA, CPA, CTDPA, UCPA, and successors) and commits to the statutory contract terms: (a) will not sell or share personal data; (b) will not retain, use, or disclose personal data except to perform the services or as permitted by law; (c) will not combine customer personal data with data from other sources except as permitted; (d) flows these restrictions down to sub-processors; and (e) assists the customer with consumer rights requests. Vendor certifies it understands and will comply with these restrictions (CCPA contractor certification). Where the customer is a HIPAA-covered entity, the parties execute a separate BAA. Breach notice within 72 hours of becoming aware; annual SOC 2 Type II furnished under NDA.
...
1. Breach notice within 48 hours of becoming aware, sub-processor disclosure with email notice of additions and a reasonable commercial objection right, deletion within 30 days.
2. Breach notice within 72 hours, sub-processor notice with an objection right, and a for-cause audit route in place of an annual on-site right.
3. Breach notice within 72 hours with an annual SOC 2 Type II under NDA satisfying routine diligence.

**Walk-away floor**

A breach window under 24 hours, pre-approval of every sub-processor, or open-ended data-residency commitments we cannot operationally meet.

**Escalation triggers**

- No 'service provider' / 'processor' certification or statutory CCPA/CPRA contract terms
- Right to 'sell' or 'share' personal data, or to use it for the vendor's own purposes
- No BAA where a HIPAA-covered entity is the customer

**Rationale**

These are the core duties we take on over customer data, so operationally infeasible breach windows or open-ended residency commitments are the terms most likely to put us in default across every customer.
...
SOC 2 Type II report furnished under NDA on annual cadence. On-site audits limited to for-cause (e.g. confirmed incident) with 30 days' notice, vendor cost-bearing only where material non-compliance is found.
...
Furnishing a SOC 2 Type II report under NDA satisfies most diligence, so we can accept for-cause on-site audits without exposing our multi-tenant environment to routine visits.
