...
> Standard offer-letter / employment-contract positions for the employer. Reasonable confidentiality + IP assignment, jurisdiction-aware non-compete handling, and at-will / notice-based termination consistent with local labour law.

**Side:** Employer · **Jurisdiction:** US

**Best fit for:**

- Hiring an employee on a standard offer letter
- Drafting an employment agreement for a salaried role

**Tags:** `employment`, `employer`, `offer-letter`, `hr`
...
Either party may terminate on 30 days' notice (or statutory minimum where greater). Termination for cause (material misconduct, criminal conviction, repeated policy breach after written warning) is immediate and without severance. Statutory severance / gratuity per applicable labour law.
...
- Notice period below statutory minimum
- 'For cause' definition not tied to documented misconduct
- No statutory severance / gratuity recognition

**Rationale**

A clean notice-plus-cause structure limits wrongful-termination exposure and keeps severance obligations predictable.
...
Employee's obligation to keep company confidential information confidential during and after employment. Trade-secret protection lasts as long as the information remains a trade secret. Standard exclusions for publicly known and independently developed information. Includes the required DTSA whistleblower-immunity notice (18 U.S.C. 1833(b)) -- omitting it forfeits exemplary damages and attorney's fees in a later trade-secret suit, and the notice must also reach consultants and independent contractors. Preserves the employee's right to report to, file a charge with, or participate in an investigation by the EEOC, NLRB, SEC, DOL, or DOJ, and to engage in NLRA Section 7 protected activity, without company notice or permission.
...
1. Standard confidentiality with the DTSA whistleblower-immunity notice and full carve-out for reports to the EEOC, NLRB, SEC, DOL, and DOJ
2. Confidentiality limited to defined trade secrets and genuinely confidential information, excluding general skills
3. Confidentiality for the term plus a fixed tail of 2 to 3 years for non-trade-secret confidential information

**Walk-away floor**

No DTSA whistleblower-immunity notice, or a clause that bars the employee from reporting to the EEOC, NLRB, SEC, or DOJ.

**Escalation triggers**

- No DTSA whistleblower-immunity notice (18 U.S.C. 1833(b)) in an employee / contractor confidentiality or IP agreement
- Confidentiality or non-disparagement drafted to bar reports to the SEC, EEOC, NLRB, or DOJ (McLaren Macomb / SEC Rule 21F-17 problem)
- Confidentiality applied to publicly available data
- Liquidated damages without proportionality

**Rationale**

Confidentiality is the employer's primary trade-secret protection, but a clause that omits the DTSA notice or gags regulator reports is unenforceable and exposes the company.
...
There is NO federal ban on post-employment non-competes. The FTC's 2024 Non-Compete Rule was vacated nationwide before it took effect (Ryan, LLC v. FTC, N.D. Tex. 2024); the FTC abandoned its appeals in September 2025, so the rule is permanently dead and the agency now pursues only case-by-case enforcement. Enforceability is governed entirely by state law. Six states void employee non-competes almost entirely: California, Minnesota, Montana, North Dakota, Oklahoma, and Wyoming (effective July 1, 2025) -- do not impose there. About a dozen more (Colorado, DC, Illinois, Maine, Maryland, Massachusetts, Nevada, New Hampshire, Oregon, Rhode Island, Virginia, Washington) void them below annually-indexed wage thresholds. Elsewhere: limit to senior employees with material access to confidential information, 12 months or less, narrowly scoped, with real consideration; confirm the governing state's law first. (Counter-trend: Florida's CHOICE Act (2025) makes non-competes easier to enforce for high earners.)
...
- Non-compete on an employee in a total-ban state (CA, MN, MT, ND, OK, WY)
- Non-compete on a below-threshold employee in a wage-threshold state (e.g. CO, DC, IL, MA, ME, MD, NV, NH, OR, RI, VA, WA)
- Non-compete on rank-and-file (non-senior) staff
...
12-month no-poach of employees and contractors known to the leaver during their last 12 months at the company. Customer non-solicit limited to customers the leaver personally serviced or had material contact with. Carve-out for general advertisements / unsolicited inbounds.
...
1. 12-month no-poach of employees and contractors the leaver knew in their last 12 months, plus customer non-solicit limited to customers personally serviced or with material contact
2. 12-month customer non-solicit only, with a carve-out for general advertising and unsolicited inbounds
3. 9-month non-solicit narrowed to a named account or business-unit list agreed at signing

**Walk-away floor**

Customer non-solicit covering the entire customer base, a term over 18 months, or no carve-out for general public postings.

**Escalation triggers**

- Customer non-solicit covering company's entire customer base
- Term over 18 months
- No carve-out for general public job postings

**Rationale**

Non-solicit is the enforceable restrictive covenant in states that void non-competes, so it must be narrow enough to survive scrutiny while still protecting the workforce and customer base.
...
Employee assigns to the company all IP created in the scope of employment using company resources. Pre-existing IP and clearly off-duty personal projects are excluded (employee-provided list at signing). Moral rights waived where applicable. Cooperation in registration of IP.
...
1. Full assignment of IP created within the scope of employment using company resources, with a signed prior-inventions list
2. Assignment scoped to work related to the company's business or actual or demonstrably anticipated research
3. Assignment of scope IP with a present license-back for clearly personal, off-duty projects the employee lists

**Walk-away floor**

Auto-assignment of off-duty inventions unrelated to the role, or no statutory (Cal. Lab. Code 2870-style) carve-out.

**Escalation triggers**

- Auto-assignment of off-duty inventions unrelated to role
- No exclusion for pre-existing IP
- Trade-secret claim over publicly known general skills

**Rationale**

Clean assignment of work-product IP is the core of the hire; an over-broad grab of off-duty inventions is void under Cal. Lab. Code 2870 and equivalents and invites litigation.
...
Mediation first, arbitration for monetary disputes, court for injunctive relief and statutory employment claims. Employee retains right to file with labour regulator regardless of arbitration.
...
- Mandatory arbitration of statutory employment claims (varies by jurisdiction)
- No carve-out for regulator filings
- Class-action waiver in jurisdictions where unenforceable in employment context

**Rationale**

A staged mediation-then-arbitration path with a court carve-out for injunctions keeps disputes efficient without waiving statutory employment claims.
